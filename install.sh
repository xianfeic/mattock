...
echo 'alias mattock="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/xianfeic/mattock" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/xianfeic/mattock'"
...
rm -rf "$HOME/.config/@mattock"
rm -rf "$HOME/.config/@mattock"
rm -rf "$HOME/.config/mattock-core"
